...
// CORS configuration to ensure headers are set properly
app.use(cors({
  origin: 'https://highlandhistories.org',  // Adjust to match your frontend URL
  methods: 'GET,POST,PUT,DELETE',
  credentials: true,
  allowedHeaders: ['Content-Type', 'Authorization']
}));
...
// Route to handle all other requests to index.html
app.get('*', (req, res) => {
